...
export const COVERAGE_MAP: readonly DeliverableCoverage[] = [
  ...
  },
  {
    ...
    requiresFields: ['identity.legalName', 'people.owners', 'offerings.core', 'offerings.core.*.priceRange', 'offerings.dontDo', 'pricing.shareable', 'pricing.deposit', 'capacity.metrics', 'positioning.keyDifferentiator', 'governance.dataRetention', 'modules.preschool.ocfs.licenseStatus', 'modules.preschool.immunizationPolicy', 'modules.preschool.enrollmentCapacity', 'modules.preschool.trainingMatrix'],
  ...
  },
  {
    ...
    requiresFields: ['people.keyTeam', 'salesProcess.leadSources', 'salesProcess.qualificationCriteria', 'salesProcess.close.definition', 'salesProcess.funnel.revenuePerCustomer', 'toolsAndAccess.crm', 'capacity.bookingLeadTime'],
  ...
  },
  {
    ...
    requiresFields: ['content.photos.storage', 'content.photos.rights', 'content.videos.rights', 'toolsAndAccess.assetStorage', 'positioning.awards'],
  ...
  },
  {
    ...
    requiresFields: ['competitors.direct', 'competitors.marketContext', 'customers.primaryCustomer', 'pricing.shareable', 'positioning.keyDifferentiator'],
  ...
  },
  {
    ...
    requiresFields: ['seo.baseline', 'seo.primaryKeywordTargets', 'identity.primaryAddress', 'toolsAndAccess.analytics', 'content.written'],
  ...
  },
  {
    ...
    requiresFields: ['offerings.core', 'offerings.dontDo', 'pricing.nonShareable', 'capacity.metrics', 'operationsAutomation.sensitiveTopics', 'operationsAutomation.escalationRouting', 'people.routing.doNotRoute', 'customers.primaryCustomer'],
  ...
  },
  {
    ...
    requiresFields: ['people.keyTeam', 'salesProcess.conversionEvent', 'salesProcess.followUpCadences', 'toolsAndAccess.scheduling', 'operationsAutomation.responseSlas'],
  ...
  },
  {
    ...
    requiresFields: ['content.productionCapacity', 'content.performingThemes', 'content.videos.rights', 'operationsAutomation.responseSlas', 'toolsAndAccess.socialAccounts'],
  ...
  },
  {
    ...
    requiresFields: ['seo.technical', 'toolsAndAccess.websiteCms', 'salesProcess.conversionEvent', 'pricing.visibilityPolicy', 'goals.engagementScope', 'goals.budgetConstraints'],
  ...
  },
  {
    ...
    requiresFields: ['operationsAutomation.recurringTasks', 'operationsAutomation.escalationRouting', 'operationsAutomation.spendCap', 'toolsAndAccess.automationPlatform', 'toolsAndAccess.apiSpend.caps', 'salesProcess.leadSources', 'goals.redLines'],
  ...
  },
  {
    ...
    requiresFields: ['seo.measurementTargets', 'salesProcess.funnel.revenuePerCustomer', 'toolsAndAccess.analytics', 'goals.budgetConstraints', 'operationsAutomation.spendCap', 'operationsAutomation.monitoring'],
  ...
  },
  {
    ...
    requiresFields: ['goals.engagementScope'],
    requiresHvVerified: [],
    requiresDocs: [],
  ...
  },
  {
    ...
    requiresFields: ['goals.engagementScope', 'operationsAutomation.monitoring'],
    requiresHvVerified: [],
    requiresDocs: [],
  ...
  },
  {
    ...
    requiresFields: ['positioning.recommendedStatement', 'pricing.shareable', 'content.testimonials'],
    requiresHvVerified: ['pricing.shareable'],
  ...
  },
  {
    ...
    requiresFields: ['governance.offboardingPlan', 'toolsAndAccess.stack'],
  ...
  },
  {
    ...
    requiresFields: ['operationsAutomation.recurringTasks', 'toolsAndAccess.stack', 'people.keyTeam'],
  ...
  },
  {
    ...
    requiresFields: ['toolsAndAccess.stack', 'toolsAndAccess.apiSpend.caps', 'governance.dataResidency', 'people.keyTeam'],
  ...
  },
  {
    ...
    requiresFields: ['operationsAutomation.recurringTasks', 'operationsAutomation.monitoring', 'toolsAndAccess.browserDeviceLandscape', 'people.keyTeam'],
  ...
  },
  {
    ...
    requiresFields: ['toolsAndAccess.browserDeviceLandscape', 'people.keyTeam'],
    requiresHvVerified: ['toolsAndAccess.browserDeviceLandscape'],
  ...
  },
  {
    ...
    requiresFields: ['people.technicalCollaborator', 'toolsAndAccess.apiSpend.caps'],
  ...
  },
  {
    ...
    requiresFields: ['people.keyTeam', 'governance.memoryIncognitoPosture'],
  ...
  },
  {
    ...
    requiresFields: ['operationsAutomation.recurringTasks', 'toolsAndAccess.assetStorage', 'governance.reviewResponsePolicy'],
